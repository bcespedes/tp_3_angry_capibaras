...
const int OPCION_MAXIMA_MENU = 15;
...
const std::string OPCION_4 = "4. Quitar un escritor de la tabla";
const std::string OPCION_5 = "5. Cambiar fecha de fallecimiento de un escritor";
const std::string OPCION_6 = "6. Listar los escritores";
const std::string OPCION_7 = "7. Sortear una lectura random para leer en una de las tertulias";
const std::string OPCION_8 = "8. Listar todas las lecturas";
const std::string OPCION_9 = "9. Listar las lecturas entre determinados anios";
const std::string OPCION_10 = "10. Listar las lecturas de un determinado escritor";
const std::string OPCION_11 = "11. Listar las novelas de determinado genero";
const std::string OPCION_12 = "12. Armar una cola ordenada por tiempo de lectura";
const std::string OPCION_13 = "13. Mostrar orden y tiempo minimo para leer todas las lecturas";
const std::string OPCION_14 = "14. Salir\n";
